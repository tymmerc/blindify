...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: "https://blindz.app/", lastModified: new Date("2026-09-04"), changeFrequency: "weekly", priority: 1 },
    // /modes/ et /solo/ sortis : ecrans d'app ("Chargement..." pour un crawler), pas du contenu.
    { url: "https://blindz.app/faq/", lastModified: new Date("2026-09-08"), changeFrequency: "monthly", priority: 0.8 },

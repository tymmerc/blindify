...
function MenuContent() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-950 via-pink-950 to-purple-900">
        <div className="text-2xl font-bold text-white">Chargement...</div>
      </div>
    )
  }
  ...
  return (
    <PageTransition>
      <main className="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-br from-purple-950 via-pink-950 to-purple-900">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pt-32 pb-40 relative z-10">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-gray-300 font-medium max-w-2xl mx-auto leading-relaxed">
              Le seul site de blind test où c&apos;est <span className="font-bold text-purple-400">ta musique</span> et
              celle de tes potes
            </p>
          </motion.div>
        ...
        <motion.div
          className="w-full py-10 bg-white/10 backdrop-blur-md border-t border-white/20
                     flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-12 
                     text-gray-200 text-base sm:text-lg font-medium px-4 relative z-10"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6, duration: 0.8 }}
        >
          <span className="flex items-center gap-3">
            <span className="font-bold text-purple-400 text-xl">1.</span> Connecte ton compte Spotify
          </span>
          <span className="flex items-center gap-3">
            <span className="font-bold text-purple-400 text-xl">2.</span> Importe tes titres likés
          </span>
          <span className="flex items-center gap-3">
            <span className="font-bold text-purple-400 text-xl">3.</span> Mélange-les et que le meilleur gagne
          </span>
        </motion.div>
      </main>
    </PageTransition>
